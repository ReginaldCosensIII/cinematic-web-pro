            ...
            {featured.map((solution, idx) => {
              ...
              return (
                <Link
                  ...
                  className="group glass-effect hover:glass-border rounded-xl p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-webdev-gradient-blue/10 animate-fade-in-up flex flex-col"
